...
import { FaHtml5, FaCss3Alt, FaJsSquare, FaPhp, FaJava } from 'react-icons/fa';
import { SiReact, SiTailwindcss, SiNextdotjs, SiLaravel, SiCplusplus } from 'react-icons/si';
      ...
      <div className="flex size-full flex-col max-w-lg max-h-[200px] items-stretch justify-between mt-[-8rem] md:mt-[-2rem]">
        <div className="relative flex items-center justify-center">
          ...
          <div className="absolute left-[-2rem] md:left-[-28rem] flex flex-col items-center space-y-6 md:space-y-9 mt-[15rem] md:mt-[0]">
            ...
            <div ref={divRefs[4]} className="flex items-center justify-center" key="java">
              <FaJava className="text-black dark:text-white text-[55px] md:text-[80px]" />
            </div>
          </div>
          ...
          <div className="absolute right-[-2rem] md:right-[-28rem] flex flex-col items-center space-y-6 md:space-y-9 mt-[15rem] md:mt-[0]">
            ...
            <div ref={divRefs[9]} className="flex items-center justify-center" key="cplusplus">
              <SiCplusplus className="text-black dark:text-white text-[55px] md:text-[80px]" />
            </div>
          </div>
        </div>
