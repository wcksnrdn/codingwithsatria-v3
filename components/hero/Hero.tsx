  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="absolute left-0 top-[20%] hidden h-[121px] w-[350px] flex-col items-start justify-center rounded-br-full rounded-tr-full bg-zinc-800 px-5 dark:bg-zinc-100 lg:flex"
      >
